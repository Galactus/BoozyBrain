...
#-----------------------------------------------------------------------------------------------------
# adapted version of evaluate_features to use classifier on selected combination of ingredients

def evaluate_newfeatures(feature_select, best_words,test_form):
    posFeatures = []
    negFeatures = []
...
#        -------------------------------------------------------------   
# Trying on OUR OWN INGREDIENTS    
  
    predicted_1 = classifier.classify(test_form)
#    
    return predicted_1
